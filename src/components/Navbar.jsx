...
import {AiOutlineClose, AiOutlineMenu, AiOutlineGithub, AiFillInstagram, AiFillCode, AiFillMail, AiFillInfoCircle} from 'react-icons/ai'
            ...
            <div className={nav ? 'z-10 fixed h-full left-0 top-0 w-[60%] bg-[#202121] ease-in-out duration-500'
             : 'fixed left-[-100%]'}>
                ...
                <ul className='p-8 text-2xl'>
                    <li className='p-2 font-medium flex'><AiFillInfoCircle size={30} className='mr-3'/><a href='#about'>About</a></li>
                    <li className='p-2 font-medium flex'><AiFillCode size={30} className='mr-3'/><a href='#work'>Work</a></li>
