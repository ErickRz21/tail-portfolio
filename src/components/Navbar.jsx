...
const Navbar = () => {
  ...
  return (
        <div className='bg-black text-gray-400 max-w-[1200px] mx-auto flex justify-between items-center'>
            ...
            <div onClick={handleNav} className='block md:hidden mr-6 p-5'>
                {nav ? <AiOutlineClose size={20}/> : <AiOutlineMenu size={20}/>}

            <div className={nav ? 'z-10 fixed h-full left-0 top-0 w-[40%] bg-[#202121] ease-in-out duration-500'
             : 'fixed left-[-100%]'}>
                <h1 className='text-3xl font-bold primary-color m-4 pl-5'>J. DOE</h1>
